...
#include <stdio.h>
#include "fgm.h"
//mData * fgm(uint32_t * list, int readLen, uint32_t * matchLocLst, int mllLen, uint32_t * rdSeq)
...
int main(int argc, char ** argv)
{
	...
	uint32_t testRefSeq [10]= {0x2D89E192, 0xD9A01F72, 0x2B9B11EE, 0x519D4F53, 0x9E987936, 0x48C5B986, 0xB5848D60, 0xEB4C6938, 0x93B1B4E1, 0x021FBBD4};
	...
	uint32_t listLen = 160;	//test ref seq of length 160.
	
	uint32_t readLen = 48;	//read length 48 base pairs.
	uint32_t testReads [34][3]= 
	{
	...
	};//there are 34 test cases. //each read sequence is 3 uint32_t's long - 48 base pairs; 96 bits.
